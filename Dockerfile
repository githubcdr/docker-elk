...
ENV ES_URL="https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-5.1.2.tar.gz"
ENV LS_URL="https://artifacts.elastic.co/downloads/logstash/logstash-5.1.2.tar.gz"
ENV  K_URL="https://artifacts.elastic.co/downloads/kibana/kibana-5.1.2-linux-x86_64.tar.gz"
